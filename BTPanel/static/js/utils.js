                ...
                bt.open({
                  ...
                  success: function (layers) {
                    if (rhtml.indexOf("CodeMirror") != -1) {
                      ...
                      loadScript([
                        "/static/codemirror/lib/codemirror.js?v=1756369731",
                        "/static/codemirror/addon/edit/editAll.js?v=1756369731",
                        "/static/codemirror/mode/modeAll.js?v=1756369731",
                        "/static/codemirror/addon/dialog/dialog.js?v=1756369731",
                        "/static/codemirror/addon/search/search.js?v=1756369731",
                        "/static/codemirror/addon/scroll/annotatescrollbar.js?v=1756369731",
                      ]);
                    }
        ...
        success: function () {
          bt_tools.send(
            ...
            function (res) {
              jQuery
                .ajax({
                  url: '/static/js/jquery.qrcode.min.js?v=1756369731',
                  dataType: 'script',
                  cache: true,
                })
                .done(function () {
